...
CUSTOM_GAME_SETUP_TIME = 0.01           -- How long should custom game setup last - the screen where players pick a team?
HERO_SELECTION_TIME = 90.0              -- How long should we let people select their hero? Should be at least 5 seconds.
...
STRATEGY_TIME = 0.01                    -- How long should strategy time last? Bug: You can buy items during strategy time and it will not be spent!
SHOWCASE_TIME = 0.01                    -- How long should show case time be?
PRE_GAME_TIME = 5.0                    -- How long after showcase time should the horn blow and the game start?
...
DEFAULT_STARTING_TIMER_VALUE = 4.5
DEFAULT_COUNTDOWN_INCREMENT_VALUE = 0.03 --0.0325
MINIMUM_COUNTDOWN_INCREMENT_VALUE = 0.525

DEFAULT_ANCIENT_STARTING_TIMER_VALUE = 15
DEFAULT_ANCIENT_COUNTDOWN_INCREMENT_VALUE = 0.5
MINIMUM_ANCIENT_COUNTDOWN_INCREMENT_VALUE = 4


-- custom units
CU_MIN_SPAWN_DISTANCE = 2500
CU_MAX_BASIC_CREEPS = 50
CU_MAX_JUNGLE_ENEMIES = 8
CU_MAX_ANCIENTS = 6
CU_MAX_BOSSES = 1
CU_START_UPGRADED_CREEPS = 8*60
CU_START_MEGA_CREEPS = 16*60
CU_START_MEDIUM_NEUTRALS = 6*60
CU_START_HARD_NEUTRALS = 9*60
CU_START_ANCIENT_NEUTRLAS = 11*60
SA_START_SCALING_ANCIENTS = 13*60
SA_ANCIENT_SCALING_PCT_PER_MIN = 0.03
CU_NEUTRAL_CHANCE_PCT = 20

CU_RANGED_CREEP_SPAWN_CHANCE = 15
CU_FLAG_CREEP_SPAWN_CHANCE = 15
CU_CATA_CREEP_SPAWN_CHANCE = 15
-- 1.0 == 100% of expected distance
SA_SPAWN_MAX_WALK_DISTANCE_MULTIPLIER = 2.0
SA_SPAWN_VALIDATATION_TREE_RADIUS = 32
-- 1 = 100%, 0.15 = 15% of starting health
CU_SPAWNED_UNIT_HEALTH_PCT = 0.15
CU_SPAWNED_ANCIENT_HEALTH_PCT = 0.9
CU_ACQ_RANGE = 999999

-- gathering nodes
SA_GATHERING_SPAWN_VARIANCE_PCT = 0.2
-- herbs
SA_MAX_GATHERING_SATURATION_PCT_HERBALISM = 0.60
SA_GATHERING_HERB_SPAWN_CHANCE_PCT = 15
SA_GATHERING_HERB_SPAWN_INTERVAL = 5*60
SA_GATHERING_RARE_HERB_CHANCE_PCT = 10

-- mining / ore
SA_MAX_GATHERING_SATURATION_PCT_MINING = 0.60
SA_GATHERING_ORE_SPAWN_CHANCE_PCT = 15
SA_GATHERING_ORE_SPAWN_INTERVAL = 5*60
